...
async function main() {
    ...
    try {
        ...
        const institutionIdMap = new Map(); // Map original ID to generated ID
        for (const institutionData of universities_data_1.institutionsData) {
        ...
        const facultyIdMap = new Map(); // Map original ID to generated ID
        for (const facultyData of universities_data_1.facultiesData) {
        ...
        const programIdMap = new Map(); // Map original ID to generated ID
        for (const programData of universities_data_1.programsData) {
        ...
        for (const requirementData of universities_data_1.requirementsData) {
        ...
        universities_data_1.institutionsData.forEach((inst) => {
